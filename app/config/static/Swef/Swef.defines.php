...
// Files
define ( 'SWEF_FILE_CONFIG_MODE',               './app/config/static/Swef.var.chmod.php'    );
define ( 'SWEF_FILE_CONFIG_DB',                 './app/config/user/Swef/Swef.var.db.php'    );
define ( 'SWEF_FILE_REQUIRES_PREG',             '/^.*\.requires\.php$/'                     );
define ( 'SWEF_FILE_UNTRANSLATED_CONTENTS',     "<?xml version=\"1.0\"?>\r\n<swef>\r\n</swef>\r\n" );

// Directories
define ( 'SWEF_DIR_CLASS',                      './app/class'                               );
define ( 'SWEF_DIR_CONFIG',                     './app/config'                              );
define ( 'SWEF_DIR_FUNCTION',                   './app/function'                            );
define ( 'SWEF_DIR_LOG',                        './app/log'                                 );
define ( 'SWEF_DIR_LOOKUP',                     './app/lookup'                              );
define ( 'SWEF_DIR_PHRASES',                    './app/phrases'                             );
define ( 'SWEF_DIR_PLUGIN',                     './app/plugin'                              );
define ( 'SWEF_DIR_ENDPOINT',                   './app/endpoint'                            );
define ( 'SWEF_DIR_TEMPLATE',                   './app/template'                            );
